...
class WordRelate:
    ...
    def __init__(self, home_dir='C:\\Users\\santi\\Desktop\\Semestre6\\FuentesDeDatos'):
...
if __name__ == '__main__':
    ...
    collections = os.listdir(os.path.join('C://Users//santi//Desktop//Semestre6//FuentesDeDatos','data', 'text_comp', 'texts'))
    # Parse arguments
    ...
    # Read stopwords
    with open('C://Users//santi//Desktop//Semestre6//FuentesDeDatos//data//stop_words//stopwords.txt') as f:
    ...
    wc.read_collection('00')
    palabras = wc.get_voc('00', stopwords)
    x = wc.dist_rep('00')
